...
type CreateTargetgroup struct {
	_                   string `action: "create" entity: "targetgroup" awsAPI: "elbv2" awsCall: "CreateTargetGroup" awsInput: "CreateTargetGroupInput" awsOutput: "CreateTargetGroupOutput"`
...
type DeleteTargetgroup struct {
	_      string `action: "delete" entity: "targetgroup" awsAPI: "elbv2" awsCall: "DeleteTargetGroup" awsInput: "DeleteTargetGroupInput" awsOutput: "DeleteTargetGroupOutput"`
	logger *logger.Logger
	api    elbv2iface.ELBV2API
	Id     *string `awsName: "TargetGroupArn" awsType: "awsstr" templateName: "id" required: ""`
}
