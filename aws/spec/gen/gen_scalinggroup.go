...
type CreateScalinggroup struct {
	_                      string `action: "create" entity: "scalinggroup" awsAPI: "autoscaling" awsCall: "CreateAutoScalingGroup" awsInput: "CreateAutoScalingGroupInput" awsOutput: "CreateAutoScalingGroupOutput"`
...
type UpdateScalinggroup struct {
	_                      string `action: "update" entity: "scalinggroup" awsAPI: "autoscaling" awsCall: "UpdateAutoScalingGroup" awsInput: "UpdateAutoScalingGroupInput" awsOutput: "UpdateAutoScalingGroupOutput"`
	logger                 *logger.Logger
	api                    autoscalingiface.AutoScalingAPI
	Name                   *string   `awsName: "AutoScalingGroupName" awsType: "awsstr" templateName: "name" required: ""`
	Cooldown               *int64    `awsName: "DefaultCooldown" awsType: "awsint64" templateName: "cooldown"`
...
type DeleteScalinggroup struct {
	_      string `action: "delete" entity: "scalinggroup" awsAPI: "autoscaling" awsCall: "DeleteAutoScalingGroup" awsInput: "DeleteAutoScalingGroupInput" awsOutput: "DeleteAutoScalingGroupOutput"`
	logger *logger.Logger
	api    autoscalingiface.AutoScalingAPI
	Name   *string `awsName: "AutoScalingGroupName" awsType: "awsstr" templateName: "name" required: ""`
