...
type CreateZone struct {
	_               string `action: "create" entity: "zone" awsAPI: "route53" awsCall: "CreateHostedZone" awsInput: "CreateHostedZoneInput" awsOutput: "CreateHostedZoneOutput"`
...
type DeleteZone struct {
	_      string `action: "delete" entity: "zone" awsAPI: "route53" awsCall: "DeleteHostedZone" awsInput: "DeleteHostedZoneInput" awsOutput: "DeleteHostedZoneOutput"`
	logger *logger.Logger
	api    route53iface.Route53API
