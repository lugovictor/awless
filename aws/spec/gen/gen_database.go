...
type CreateDatabase struct {
	_                 string `action: "create" entity: "database" awsAPI: "rds" awsCall: "CreateDBInstance" awsInput: "CreateDBInstanceInput" awsOutput: "CreateDBInstanceOutput"`
...
type DeleteDatabase struct {
	_            string `action: "delete" entity: "database" awsAPI: "rds" awsCall: "DeleteDBInstance" awsInput: "DeleteDBInstanceInput" awsOutput: "DeleteDBInstanceOutput"`
	logger       *logger.Logger
	api          rdsiface.RDSAPI
	Id           *string `awsName: "DBInstanceIdentifier" awsType: "awsstr" templateName: "id" required: ""`
